...
for idx=companies
    ...
    for year=years
        ...
        %save('KRW-250-4000-2014-2014-P-save.mat', 'K','P');
        load('KRW-250-4000-2014-2014-P-save.mat');
        ...
        set(ax(2),'ylim',[min(X) max(X)+35]);
        set(ax,{'ycolor'},{'k';'k'})
        y=ylabel(ax(2), 'KRW daily exchange rate', 'Color','black'); % label left y-axis
        %ylabel
        ...
        %set(ax(1),'ylim',[min(maxes(:,1)) max(maxes(:,1))])
        set(ax,{'ycolor'},{'k';'k'})
        y=ylabel(ax(2), 'KRW daily exchange rate', 'Color','black')
        xlabel(ax(1), 'Day'); % label left y-axis
        %set(ax(1),'YDir','reverse');
